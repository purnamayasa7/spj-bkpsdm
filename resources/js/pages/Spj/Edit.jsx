                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            value={form.pptk}
                                            readOnly
                                            className="w-full pl-3 pr-8 py-2 bg-slate-100 dark:bg-slate-700/80 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-600 dark:text-slate-300 cursor-not-allowed"
                                        />
                                        <Lock className="w-3.5 h-3.5 text-slate-400 dark:text-slate-500 absolute right-2.5 top-1/2 -translate-y-1/2" />
                                    </div>
                                </div>
