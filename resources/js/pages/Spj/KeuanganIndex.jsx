                ...
                <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span
                                className={`px-2.5 py-0.5 rounded-full text-xs font-semibold ${isDisetujui
                            ...
                            >
                                {isDisetujui ? 'Arsip Disetujui' : (isDikoreksi ? 'Menunggu Perbaikan Bidang' : 'Pengajuan Masuk')}
                            </span>
                        </div>
                                    ...
                                    paginatedSpj.map((item) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-center whitespace-nowrap">
                                                <span
                                                    className={`inline-block px-2.5 py-1 rounded-full text-[11px] font-bold border ${item.status === 'Disetujui'
